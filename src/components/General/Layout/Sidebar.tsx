...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside
      className="w-64 md:w-70 text-white p-6 md:p-8 rounded-3xl shadow-lg min-h-full z-50 bg-opacity-30 backdrop-blur-md border-5 fixed md:static top-0 left-0 bg-blue-900 transition-transform md:transform-none"
      style={{
        background:
